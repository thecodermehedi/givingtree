...
const Logo = ({width}) => {
  return (
    <div className={`${width} w-36`}>
      <svg
        version="1.1"
        viewBox="0 0 2000 191"
        xmlns="http://www.w3.org/2000/svg"
        xmlnsXlink="http://www.w3.org/1999/xlink"
      >
        <g transform="translate(-1.2121 -.49517)">
          <svg
            width="2e3"
            height="191"
            ...
            xmlnsXlink="http://www.w3.org/1999/xlink"
          >
            <g transform="translate(.24 .098516)">
              <svg
                width="395.52"
                height="37.803"
                viewBox="0 0 395.52 37.80296771543766"
              >
                <svg
                  width="395.52"
                  height="37.803"
                  viewBox="0 0 444.39591166901255 42.47442430647292"
                >
                  <rect
                    x="35.087"
                    width="3.8113"
                    ...
                    data-palette-color="#31c48d"
                    fillOpacity="1"
                    strokeWidth="0"
                  />
                  <g transform="translate(48.876 .10566)">
                    <svg
                      width="395.52"
                      height="42.263"
                      viewBox="0 0 395.52 42.26310876265963"
                    >
                      <svg
                        width="395.52"
                        height="42.263"
                  ...
                  <g transform="translate(0 .10566)">
                    <svg
                      width="25.11"
                      height="42.263"
                      viewBox="0 0 25.109969576760395 42.26310876265963"
                    >
                      <svg
                        width="25.11"
                        height="42.263"
